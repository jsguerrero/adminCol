# Generated by Django 2.1 on 2018-09-29 19:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cla_asentamiento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colonias.cat_asentamiento')),
                ('cla_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='cat_estado',
